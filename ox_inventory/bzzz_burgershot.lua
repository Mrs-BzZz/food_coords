	['bzzz_fastfood_burgershot_drink_a'] = {
		...
		client = {
			...
			prop = { model = `bzzz_fastfood_burgershot_drink_a`, pos = vec3(0.02, 0.00, -0.01), rot = vec3(0.0, 0.0, 0.0) },
			usetime = 2500,
			cancel = true,
	...
	['bzzz_fastfood_burgershot_drink_b'] = {
		...
		client = {
			status = { thirst = 200000 },
			anim = { dict = 'mp_player_intdrink', clip = 'loop_bottle' },
			prop = { model = `bzzz_fastfood_burgershot_drink_b`, pos = vec3(0.02, 0.00, 0.01), rot = vec3(0.0, 0.0, 0.0) },
			usetime = 2500,
			cancel = true,
			notification = 'Bon appétit'
		}
	...
	['bzzz_fastfood_burgershot_chicken_a'] = {
		...
		client = {
			...
			prop = { model = `bzzz_fastfood_burgershot_chicken_a`, pos = vec3(-0.02, 0.0, -0.01), rot = vec3(41.0, 35.0, -70.0) },
			usetime = 2500,
			cancel = true,
			notification = 'Bon appétit'
		}
	...
	['bzzz_fastfood_burgershot_chicken_b'] = {
		...
		client = {
			status = { thirst = 200000 },
			anim = { dict = 'mp_player_inteat@burger', clip = 'mp_player_int_eat_burger' },
			prop = { model = `bzzz_fastfood_burgershot_chicken_b`, pos = vec3(-0.02, 0.0, -0.01), rot = vec3(41.0, 35.0, -70.0) },
			usetime = 2500,
			cancel = true,
			notification = 'Bon appétit'
		}
	...
	['bzzz_fastfood_burgershot_icecream_a'] = {
		...
		client = {
			status = { thirst = 200000 },
			anim = { dict = 'mp_player_inteat@burger', clip = 'mp_player_int_eat_burger' },
			prop = { model = `bzzz_fastfood_burgershot_icecream_a`, pos = vec3(-0.02, 0.0, -0.01), rot = vec3(1.0, -85.0, 10.0) },
			usetime = 2500,
			cancel = true,
			notification = 'Bon appétit'
		}
	...
	['bzzz_fastfood_burgershot_icecream_b'] = {
		...
		client = {
			status = { thirst = 200000 },
			anim = { dict = 'mp_player_inteat@burger', clip = 'mp_player_int_eat_burger' },
			prop = { model = `bzzz_fastfood_burgershot_icecream_b`, pos = vec3(-0.02, 0.0, -0.01), rot = vec3(1.0, -85.0, 10.0) },
			usetime = 2500,
			cancel = true,
			notification = 'Bon appétit'
		}
	...
	['bzzz_fastfood_burgershot_bigburger_a'] = {
		...
		client = {
			status = { thirst = 200000 },
			anim = { dict = 'mp_player_inteat@burger', clip = 'mp_player_int_eat_burger' },
			prop = { model = `bzzz_fastfood_burgershot_bigburger_a`, pos = vec3(-0.01, 0.0, -0.02), rot = vec3(31.0, 15.0, 0.0) },
			usetime = 2500,
			cancel = true,
			notification = 'Bon appétit'
		}
	...
	['bzzz_fastfood_burgershot_cheeseburger_a'] = {
		...
		client = {
			status = { thirst = 200000 },
			anim = { dict = 'mp_player_inteat@burger', clip = 'mp_player_int_eat_burger' },
			prop = { model = `bzzz_fastfood_burgershot_cheeseburger_a`, pos = vec3(-0.01, 0.0, -0.02), rot = vec3(31.0, 15.0, 0.0) },
			usetime = 2500,
			cancel = true,
			notification = 'Bon appétit'
		}
	...
	['bzzz_fastfood_burgershot_nugget_a'] = {
		...
		client = {
			status = { thirst = 200000 },
			anim = { dict = 'mp_player_inteat@burger', clip = 'mp_player_int_eat_burger' },
			prop = { model = `bzzz_fastfood_burgershot_nugget_a`, pos = vec3(-0.04, 0.01, -0.01), rot = vec3(01.0, 45.0, -85.0) },
			usetime = 2500,
			cancel = true,
			notification = 'Bon appétit'
		}
	...
	['bzzz_fastfood_burgershot_onion_a'] = {
		...
		client = {
			status = { thirst = 200000 },
			anim = { dict = 'mp_player_inteat@burger', clip = 'mp_player_int_eat_burger' },
			prop = { model = `bzzz_fastfood_burgershot_onion_a`, pos = vec3(-0.04, 0.01, -0.01), rot = vec3(01.0, 45.0, -85.0) },
			usetime = 2500,
			cancel = true,
			notification = 'Bon appétit'
		}
	...
	['bzzz_fastfood_burgershot_noodle_a'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_noodle_a',
            bone = 60309,
            pos = vec3(0.08, 0.05, 0.08),
            rot = vec3(-40.0, -10.0, -30.0) },

            propTwo = { model = 'bzzz_fastfood_burgershot_noodle_b',
            bone = 28422,
	...
	['bzzz_fastfood_burgershot_chicken_d'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_chicken_d',
            bone = 60309,
            pos = vec3(0.09, 0.02, 0.04),
            rot = vec3(30.0, 35.0, 134.0) },

            propTwo = { model = 'bzzz_fastfood_burgershot_chicken_a',
            bone = 28422,
	...
	['bzzz_fastfood_burgershot_chicken_e'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_chicken_e',
            bone = 60309,
            pos = vec3(0.09, 0.02, 0.04),
            rot = vec3(30.0, 35.0, 134.0) },

            propTwo = { model = 'bzzz_fastfood_burgershot_chicken_b',
            bone = 28422,
	...
	['bzzz_fastfood_burgershot_chicken_f'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_chicken_f',
            bone = 60309,
            pos = vec3(0.09, 0.02, 0.04),
            rot = vec3(30.0, 35.0, 134.0) },

            propTwo = { model = 'bzzz_fastfood_burgershot_chicken_c',
            bone = 28422,
            pos = vec3(0.09, 0.05, -0.04),
            rot = vec3(13.0, 37.0, 124.0) },
	...
	['bzzz_fastfood_burgershot_fries_d'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_fries_d',
            bone = 60309,
	...
	['bzzz_fastfood_burgershot_nugget_b'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_nugget_b',
            bone = 60309,
            pos = vec3(0.15, 0.02, 0.02),
            rot = vec3(30.0, 35.0, 134.0) },

            propTwo = { model = 'bzzz_fastfood_burgershot_nugget_a',
            bone = 28422,
	...
	['bzzz_fastfood_burgershot_onion_b'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_onion_b',
            bone = 60309,
            pos = vec3(0.16, 0.02, 0.02),
            rot = vec3(30.0, 35.0, 134.0) },

            propTwo = { model = 'bzzz_fastfood_burgershot_onion_a',
            bone = 28422,
	...
	['bzzz_fastfood_burgershot_vegesalad_a'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_vegesalad_a',
            bone = 60309,
            pos = vec3(0.11, -0.01, 0.05),
            rot = vec3(-30.0, 10.0, 0.0) },

            propTwo = { model = 'bzzz_fastfood_burgershot_vegesalad_b',
            bone = 28422,
	...
	['bzzz_fastfood_burgershot_fries_a'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_fries_a',
            bone = 60309,
	...
	['bzzz_fastfood_burgershot_fries_b'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_fries_b',
            bone = 60309,
            pos = vec3(0.09, 0.04, 0.05),
            rot = vec3(-80.0, 50.0, 0.0) },
	...
	['bzzz_fastfood_burgershot_menu_a'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_menu_a',
            bone = 60309,
	...
	['bzzz_fastfood_burgershot_menu_b'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_menu_b',
            bone = 60309,
            pos = vec3(0.09, 0.02, 0.05),
            rot = vec3(-10.0, -40.0, -90.0) },
	...
	['bzzz_fastfood_burgershot_menu_c'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_menu_c',
            bone = 60309,
            pos = vec3(0.09, 0.02, 0.05),
            rot = vec3(-10.0, -40.0, -90.0) },
	...
	['bzzz_fastfood_burgershot_menu_d'] = {
        ...
        client = {
            ...
            prop = { model = 'bzzz_fastfood_burgershot_menu_d',
            bone = 60309,
            pos = vec3(0.09, 0.02, 0.05),
            rot = vec3(-10.0, -40.0, -90.0) },
